...
class Valor_matricula(models.Model):
    fecha = models.DateField(verbose_name="Fecha Asignada") # solo se Permite una Fecha unica para los valores no se puede repetir en la tabal
    valor_matricula_presencial = models.DecimalField(max_digits=6, decimal_places=2, verbose_name="Matricula ",default=None)
    valor_matricula_online = models.DecimalField(max_digits=6, decimal_places=2, verbose_name="Valor Matricula", default=None)
